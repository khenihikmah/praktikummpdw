...
ts.plot(data.ts, xlab="Time Period ", ylab="Total", main= "Time Series Plot of Total")
points(data.ts)
```
...
testing.ts<-ts(testing,start=59)
...
plot(data$y,data$x1, pch = 20, col = "blue",
...
#Eksplorasi Data
#Pembuatan Scatter Plot
plot(data$y,data$x2, pch = 20, col = "blue",
     main = "Scatter Plot Tahun vs Nilai IPM",
     xlab = "Tahun",
     ylab = "Nilai IPM")
#Menampilkan Nilai Korelasi
...
#Transformasi Balik
cat("y = ", coef(modelHL)[1]/(1-0.4829805), "+", coef(modelHL)[2],"x", sep = "")
```
